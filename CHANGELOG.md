...
the wemos oled display is also supported (#define OLED 2) and required this library branch to support 64x48 resolution [https://github.com/marcobrianza/esp8266-oled-ssd1306]()
